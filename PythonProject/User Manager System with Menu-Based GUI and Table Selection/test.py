...
from PyQt6.QtWidgets import QApplication, QMainWindow, QLineEdit, QPushButton, QHBoxLayout, \
    QTableWidget, QMessageBox, QTableWidgetItem, QDialog, QVBoxLayout, QFormLayout \
...
class AddUserDialog(QDialog):
    def __init__(self):
        ...
        self.addUser_button = QPushButton("Add")
        ...
        button_layout.addWidget(self.addUser_button)
    ...
    def delete_selected_user(self):
        ...
        if confirmation == QMessageBox.StandardButton.Yes:
            ...
            if connection:
                cursor = connection.cursor()
                try:
                    cursor.execute("DELETE FROM accounts WHERE users_id = %s", (self.selected_user_id,))
                    connection.commit()
