...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.display_button.clicked.connect(self.open_display_contacts)
    ...
    def open_display_contacts(self):
        self.display_window = DisplayContactsWindow(self.manager)
...
class DisplayContactsWindow(QWidget):
    def __init__(self, manager):
        super().__init__()
        self.setWindowTitle("Contacts List")
        self.setGeometry(200, 200, 300, 300)

        layout = QVBoxLayout()

        contacts_list = manager.display_contacts()
